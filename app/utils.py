...
def generate_question_message(statement: str, url:str, text: str) -> list:
    ...
    message = [{
        ...
        Return please just single json file with three keys: (1) "title", (2) "summary" and (3) "score" assigned to the article. No natural language explanation or irrelevant symbols are needed
        """,
    }]
